/** Copied from https://github.com/alanko0511/noisejs-typescript
 * @NOTE found github issue on the original noisejs github and this author
 * posted this as a typescript solution.
 */
class Grad {
